...
class ProductRemoteDataSourceImpl implements ProductRemoteDataSource {
  ...
  Future<List<ProductModel>> getRecommendedProducts() async {
    ...
    final products = [
      const ProductModel(id: '1', name: 'Honey lime combo', price: '2,000', image: AppAssets.product_1),
      const ProductModel(id: '2', name: 'Berry mango combo', price: '8,000', image: AppAssets.product_2),
      const ProductModel(id: '3', name: 'Quinoa fruit salad', price: '10,000', image: AppAssets.product_3),
    ];
  ...
  Future<List<ProductModel>> getCategoryProducts() async {
    ...
    await Future.delayed(const Duration(milliseconds: 500));
    final products = [
      const ProductModel(id: '4', name: 'Quinoa fruit salad', price: '10,000', image: AppAssets.product_4),
      const ProductModel(id: '5', name: 'Tropical fruit salad', price: '10,000', image: AppAssets.product_1),
      const ProductModel(id: '1', name: 'Melon fruit salad', price: '10,000', image: AppAssets.product_5),
    ];
